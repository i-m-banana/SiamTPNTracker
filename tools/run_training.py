...
def main():
    ...
    parser.add_argument('--config', default=r'E:\pycharm_work\SiamTPNTracker\experiments\shufflenet_l345_192.yaml', type=str, help="Name of the config file.")
